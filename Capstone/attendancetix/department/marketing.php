...
if (!isset($_SESSION['department']) || $_SESSION['department'] !== 'marketing') {
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo text-primary" href="#.php">Marketing's Dashboard</a>
          <a class="navbar-brand brand-logo-mini" href="#.php"><img src="images/UI-icon.png" alt="logo"/></a>
        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="#">
              ...
              <span class="menu-title text-primary">Dashboard</span>
            </a>
          </li>
                ...
                <div class="d-flex align-items-end flex-wrap">
                  <div class="me-md-3 me-xl-5">
                    ...
                    <br> </br>
                     ...
                     <table border="1px solid" style="width: 230%">
                      <tr>
                        <th>First Name </th>
                        <th>Last Name </th>
                        <th>Student ID </th>
                      ...
                      $departmentFilter = "MARKETING"; // Change this to the desired department

...
if (!isset($_SESSION['department']) || $_SESSION['department'] !== 'registrar') {
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo text-primary" href="#">Registrar's Dashboard</a>
          <a class="navbar-brand brand-logo-mini" href="#"><img src="images/UI-icon.png" alt="logo"/></a>
                  ...
                  <div class="me-md-3 me-xl-5">
                    ...
                    <br> </br>
                     ...
                     <table border="1px solid" style="width: 230%">
                      ...
                      $departmentFilter = "REGISTRAR"; // Change this to the desired department
